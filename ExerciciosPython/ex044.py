...
if forma_pagamento == 1:
    pagamento = preço * 0.90
    print(f'O valor sera de {pagamento:.2f}')
elif forma_pagamento == 2:
    pagamento = preço * 0.95
    ...
    if parcelas <= 2 and parcelas != 0 and not parcelas < 0:
        ...
        print(f'O valor a ser pago será de R${pagamento:.2f} por parcela. Total de R${preço:.2f}.')
    elif parcelas >2:
        pagamento = (preço / parcelas) * 1.2
        print(f'O valor a ser pago será de R${pagamento:.2f} por parcela. Total de R${preço * 1.2:.2f}.')
    else:
